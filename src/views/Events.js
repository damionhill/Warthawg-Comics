...
function Events()
{
 return(
    ...
    <div className="text-wrapper">
        ...
        <EventInstance linkURL = "http://www.philadelphiacomic-con.com/" name = "Philadelphia, PA Comic Book Show" date = "Apr 27,2025 10-3PM" address = "Clarion Hotel 76 Industrial Hwy Essington, PA 19029"/>
