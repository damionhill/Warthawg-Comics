...
function Events()
{
 return(
    ...
    <div className="text-wrapper">
        ...
        <EventInstance linkURL = "https://www.shoffpromotions.com/" name = "Frederick, MD Comic Show" date = "Mar 20, 2022 10AM-4PM" address = "5400 Holiday Drive Frederick, MD 21703"/>
