...
function Events()
{
 return(
    ...
    <div className="text-wrapper">
        ...
        <EventInstance linkURL = "https://www.shoffpromotions.com/" name = "Frederick, MD Comic Show" date = "Nov 21, 2021 10AM-3PM" address = "5400 Holiday Drive Frederick, MD 21703"/>
