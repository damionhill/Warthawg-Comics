...
function Events()
{
 return(
    ...
    <div className="text-wrapper">
        ...
        <EventInstance linkURL = "https://www.shoffpromotions.com/" name = "Annandale, VA Comic Show" date = "Jan 2, 2022 10AM-3PM" address = "7128 Columbia Pike Annandale, VA 22003"/>
